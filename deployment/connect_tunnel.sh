...
SSH_CMD="ssh -L $TARGET_PORT:$TARGET_HOST:$TARGET_PORT $SOURCE_USER@$SOURCE_HOST -p $SOURCE_PORT"
AUTOSH_CMD="autossh -M 0 -f -N -L $TARGET_PORT:$TARGET_HOST:$TARGET_PORT $SOURCE_USER@$SOURCE_HOST -p $SOURCE_PORT"
